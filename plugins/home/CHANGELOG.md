...
- bcf312fa5: The homepage `<Header />` is now part of the composable canvas (allowing you to add the <HomepageTimer />, for example).
...
- 1da51fec2: Adjust dependencies to `@types/react` and `react-router` to follow the pattern
